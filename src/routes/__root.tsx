...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { name: "description", content: "PueiOS simulates a nostalgic, interactive operating system with a glossy, retro-futuristic UI." },
      { name: "author", content: "Lovable" },
      { property: "og:title", content: "pueios softweare" },
      { property: "og:description", content: "PueiOS simulates a nostalgic, interactive operating system with a glossy, retro-futuristic UI." },
