...
const APP_ICON_SVGS: Partial<Record<AppId, (s: number) => React.ReactNode>> = {
  ...
  "pueinet": (s) => <svg width={s} height={s} viewBox="0 0 48 48"><circle cx="24" cy="24" r="22" fill="#1a4fd8"/><circle cx="24" cy="24" r="22" fill="rgba(255,255,255,0.1)"/><polygon points="10,10 22,36 26,26 36,22" fill="white" opacity="0.95"/><circle cx="36" cy="22" r="3" fill="#7dd3fc" opacity="0.9"/><ellipse cx="16" cy="12" rx="9" ry="3.5" fill="rgba(255,255,255,0.45)" transform="rotate(-28 16 12)"/></svg>,
...
const APP_ICON_SVGS_P1: Partial<Record<AppId, (s: number) => React.ReactNode>> = {
  ...
  "pueinet": (s) => <svg width={s} height={s} viewBox="0 0 48 48"><defs><radialGradient id="xpnet1" cx="35%" cy="30%" r="65%"><stop offset="0%" stopColor="#6898f8"/><stop offset="100%" stopColor="#1038c8"/></radialGradient></defs><circle cx="24" cy="24" r="22" fill="url(#xpnet1)" stroke="#0828a8" strokeWidth="1.5"/><polygon points="10,10 22,37 26,26 37,22" fill="white" opacity="0.95" stroke="#8ab4f8" strokeWidth="0.8" strokeLinejoin="round"/><circle cx="37" cy="22" r="3.5" fill="#bfdbfe" stroke="#60a5fa" strokeWidth="1"/><ellipse cx="16" cy="12" rx="9" ry="3.5" fill="rgba(255,255,255,0.45)" transform="rotate(-28 16 12)"/></svg>,
...
const APP_ICON_SVGS_P3: Partial<Record<AppId, (s: number) => React.ReactNode>> = {
  ...
  "pueinet": (s) => <svg width={s} height={s} viewBox="0 0 48 48"><rect width="48" height="48" rx="11" fill="#1565c0"/><polygon points="10,10 22,37 26,26 37,22" fill="white" opacity="0.95"/><circle cx="37" cy="22" r="4" fill="#90caf9"/></svg>,
