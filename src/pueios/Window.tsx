...
const APP_ICON_SVGS: Partial<Record<AppId, (s: number) => React.ReactNode>> = {
  ...
  // File Explorer — computer monitor icon
  "file-explorer": (s) => <svg width={s} height={s} viewBox="0 0 48 48"><defs><linearGradient id="fe1" x1="0" y1="0" x2="0" y2="1"><stop offset="0%" stopColor="#ddeeff"/><stop offset="100%" stopColor="#90b8d8"/></linearGradient><linearGradient id="fe2" x1="0" y1="0" x2="0" y2="1"><stop offset="0%" stopColor="#e8f4ff"/><stop offset="100%" stopColor="#b8d4f0"/></linearGradient></defs><rect x="3" y="5" width="42" height="28" rx="4" fill="url(#fe1)" stroke="#6090b8" strokeWidth="1.5"/><rect x="6" y="8" width="36" height="22" rx="2" fill="#5880a8" stroke="#3060a0" strokeWidth="0.8"/><rect x="8" y="10" width="32" height="18" rx="1.5" fill="url(#fe2)"/><rect x="11" y="13" width="10" height="8" rx="1.5" fill="white" opacity="0.75"/><rect x="23" y="13" width="14" height="3" rx="1.2" fill="white" opacity="0.55"/><rect x="23" y="18" width="10" height="2.5" rx="1.2" fill="white" opacity="0.4"/><rect x="20" y="33" width="8" height="5" rx="1" fill="#8090a8"/><rect x="15" y="37" width="18" height="3.5" rx="1.5" fill="#6888b0" stroke="#5070a0" strokeWidth="0.5"/></svg>,
  ...
  "calculator": (s) => <svg width={s} height={s} viewBox="0 0 48 48"><defs><linearGradient id="ca1" x1="0" y1="0" x2="0.3" y2="1"><stop offset="0%" stopColor="#d0d4e0"/><stop offset="40%" stopColor="#9098b0"/><stop offset="100%" stopColor="#606880"/></linearGradient><linearGradient id="ca2" x1="0" y1="0" x2="0" y2="1"><stop offset="0%" stopColor="#a0f8a0"/><stop offset="50%" stopColor="#20c820"/><stop offset="100%" stopColor="#106010"/></linearGradient><linearGradient id="ca3" x1="0" y1="0" x2="0" y2="1"><stop offset="0%" stopColor="rgba(255,255,255,0.7)"/><stop offset="100%" stopColor="rgba(255,255,255,0)"/></linearGradient></defs><rect x="6" y="3" width="36" height="42" rx="5" fill="url(#ca1)" stroke="#404858" strokeWidth="1"/><rect x="10" y="7" width="28" height="9" rx="2" fill="url(#ca2)" stroke="#108010" strokeWidth="0.8"/><rect x="10" y="7" width="28" height="4.5" rx="2" fill="rgba(255,255,255,0.35)"/><text x="36" y="15" textAnchor="end" fontSize="7" fill="#004000" fontFamily="monospace" fontWeight="bold">0</text>{[0,1,2,3].map(r=>[0,1,2,3].map(c=><rect key={`${r}${c}`} x={10+c*7} y={20+r*6} width="5.5" height="4.5" rx="1.5" fill={r===3&&c===3?"#e84040":r===0?"#9098b8":"#c8d0e8"} stroke="#6070a0" strokeWidth="0.4"/>))}<rect x="6" y="3" width="36" height="15" rx="5" fill="url(#ca3)" opacity="0.5"/></svg>,
  ...
  // PueiWeb — glass browser window, Aero chrome bar, vivid blue
  "pueinet": (s) => <svg width={s} height={s} viewBox="0 0 48 48"><defs><linearGradient id="pw1" x1="0" y1="0" x2="0" y2="1"><stop offset="0%" stopColor="#90c8ff"/><stop offset="45%" stopColor="#1868d8"/><stop offset="100%" stopColor="#082898"/></linearGradient><linearGradient id="pw2" x1="0" y1="0" x2="0" y2="1"><stop offset="0%" stopColor="#d8ecff"/><stop offset="100%" stopColor="#aad0ff"/></linearGradient><linearGradient id="pw3" x1="0" y1="0" x2="0" y2="1"><stop offset="0%" stopColor="rgba(255,255,255,0.85)"/><stop offset="100%" stopColor="rgba(255,255,255,0)"/></linearGradient></defs><rect x="2" y="5" width="44" height="38" rx="4" fill="url(#pw1)" stroke="#041880" strokeWidth="0.8"/><rect x="2" y="5" width="44" height="11" rx="4" fill="url(#pw2)"/><rect x="2" y="12" width="44" height="4" fill="url(#pw2)"/><circle cx="8" cy="10" r="2.5" fill="#f03030"/><circle cx="15" cy="10" r="2.5" fill="#e8c000"/><circle cx="22" cy="10" r="2.5" fill="#28c028"/><rect x="26" y="7.5" width="16" height="5" rx="2.5" fill="rgba(255,255,255,0.3)" stroke="rgba(255,255,255,0.5)" strokeWidth="0.5"/><path d="M13 7.5 L18 10 L13 12.5z" fill="#1868d8" opacity="0.8"/><path d="M9 7.5 L11 10 L9 12.5z" fill="#1868d8" opacity="0.5"/><rect x="7" y="21" width="34" height="2.5" rx="1.2" fill="rgba(255,255,255,0.65)"/><rect x="7" y="26" width="24" height="2.5" rx="1.2" fill="rgba(255,255,255,0.45)"/><rect x="7" y="31" width="30" height="2.5" rx="1.2" fill="rgba(255,255,255,0.35)"/><rect x="7" y="36" width="18" height="2.5" rx="1.2" fill="rgba(255,255,255,0.25)"/><rect x="2" y="5" width="44" height="12" rx="4" fill="url(#pw3)" opacity="0.65"/></svg>,
  ...
  // Task Manager — charcoal panel, color process bars
  "task-manager": (s) => <svg width={s} height={s} viewBox="0 0 48 48"><defs><linearGradient id="tm1" x1="0" y1="0" x2="0.2" y2="1"><stop offset="0%" stopColor="#d0d4e0"/><stop offset="100%" stopColor="#606880"/></linearGradient><linearGradient id="tm2" x1="0" y1="0" x2="0" y2="1"><stop offset="0%" stopColor="rgba(255,255,255,0.7)"/><stop offset="100%" stopColor="rgba(255,255,255,0)"/></linearGradient></defs><rect x="4" y="4" width="40" height="40" rx="4" fill="url(#tm1)" stroke="#404858" strokeWidth="1"/><rect x="8" y="8" width="32" height="6" rx="2" fill="#1060d0" opacity="0.85"/><rect x="8" y="8" width="22" height="6" rx="2" fill="#20a0ff" opacity="0.9"/><rect x="8" y="17" width="32" height="5" rx="2" fill="#0a5020" opacity="0.8"/><rect x="8" y="17" width="18" height="5" rx="2" fill="#20d060" opacity="0.9"/><rect x="8" y="25" width="32" height="5" rx="2" fill="#602000" opacity="0.8"/><rect x="8" y="25" width="12" height="5" rx="2" fill="#ff6020" opacity="0.9"/><rect x="8" y="33" width="32" height="5" rx="2" fill="#505060" opacity="0.7"/><rect x="8" y="33" width="28" height="5" rx="2" fill="#a0c0ff" opacity="0.8"/><rect x="4" y="4" width="40" height="16" rx="4" fill="url(#tm2)" opacity="0.4"/></svg>,
