...
const APP_ICON_SVGS: Partial<Record<AppId, (s: number) => React.ReactNode>> = {
  ...
  "app-store": (s) => <svg width={s} height={s} viewBox="0 0 48 48"><rect x="3" y="3" width="42" height="42" rx="10" fill="#00a870"/><rect x="3" y="3" width="42" height="42" rx="10" fill="rgba(255,255,255,0.15)"/><path d="M24 8 L28 18 H39 L30.5 24 L34 34 L24 28 L14 34 L17.5 24 L9 18 H20 Z" fill="#ffff44"/><path d="M24 8 L28 18 H39 L30.5 24 L34 34 L24 28 L14 34 L17.5 24 L9 18 H20 Z" fill="rgba(255,255,255,0.1)"/><ellipse cx="24" cy="15" rx="16" ry="6" fill="rgba(255,255,255,0.44)"/></svg>,
