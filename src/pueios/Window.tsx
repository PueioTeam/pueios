...
const APP_ICON_SVGS: Partial<Record<AppId, (s: number) => React.ReactNode>> = {
  ...
  "pueinet": (s) => <svg width={s} height={s} viewBox="0 0 48 48"><circle cx="24" cy="24" r="22" fill="#0d47a1"/><circle cx="24" cy="24" r="22" fill="rgba(255,255,255,0.1)"/><ellipse cx="24" cy="24" rx="22" ry="10" fill="none" stroke="rgba(255,255,255,0.5)" strokeWidth="1.5"/><ellipse cx="24" cy="24" rx="10" ry="22" fill="none" stroke="rgba(255,255,255,0.5)" strokeWidth="1.5"/><circle cx="24" cy="24" r="22" fill="none" stroke="rgba(255,255,255,0.5)" strokeWidth="1.5"/><line x1="2" y1="24" x2="46" y2="24" stroke="rgba(255,255,255,0.5)" strokeWidth="1.5"/><line x1="24" y1="2" x2="24" y2="46" stroke="rgba(255,255,255,0.5)" strokeWidth="1.5"/><ellipse cx="18" cy="10" rx="12" ry="5" fill="rgba(255,255,255,0.48)" transform="rotate(-25 18 10)"/></svg>,
...
const APP_ICON_SVGS_P1: Partial<Record<AppId, (s: number) => React.ReactNode>> = {
  ...
  "pueinet": (s) => <svg width={s} height={s} viewBox="0 0 48 48"><defs><radialGradient id="xpnet1" cx="35%" cy="30%" r="70%"><stop offset="0%" stopColor="#5888f0"/><stop offset="100%" stopColor="#1030c0"/></radialGradient></defs><circle cx="24" cy="24" r="22" fill="url(#xpnet1)" stroke="#1028a0" strokeWidth="1.5"/><ellipse cx="24" cy="24" rx="22" ry="10" fill="none" stroke="rgba(255,255,255,0.55)" strokeWidth="1.2"/><ellipse cx="24" cy="24" rx="10" ry="22" fill="none" stroke="rgba(255,255,255,0.55)" strokeWidth="1.2"/><circle cx="24" cy="24" r="22" fill="none" stroke="rgba(255,255,255,0.55)" strokeWidth="1.2"/><line x1="2" y1="24" x2="46" y2="24" stroke="rgba(255,255,255,0.55)" strokeWidth="1.2"/><line x1="24" y1="2" x2="24" y2="46" stroke="rgba(255,255,255,0.55)" strokeWidth="1.2"/><ellipse cx="17" cy="11" rx="11" ry="4.5" fill="rgba(255,255,255,0.45)" transform="rotate(-28 17 11)"/></svg>,
...
const APP_ICON_SVGS_P3: Partial<Record<AppId, (s: number) => React.ReactNode>> = {
  ...
  "pueinet": (s) => <svg width={s} height={s} viewBox="0 0 48 48"><rect width="48" height="48" rx="11" fill="#1565c0"/><circle cx="24" cy="24" r="18" fill="none" stroke="rgba(255,255,255,0.65)" strokeWidth="1.5"/><ellipse cx="24" cy="24" rx="18" ry="8" fill="none" stroke="rgba(255,255,255,0.65)" strokeWidth="1.5"/><ellipse cx="24" cy="24" rx="8" ry="18" fill="none" stroke="rgba(255,255,255,0.65)" strokeWidth="1.5"/><line x1="6" y1="24" x2="42" y2="24" stroke="rgba(255,255,255,0.65)" strokeWidth="1.5"/><line x1="24" y1="6" x2="24" y2="42" stroke="rgba(255,255,255,0.65)" strokeWidth="1.5"/></svg>,
