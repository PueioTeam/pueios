...
const APP_ICON_SVGS: Partial<Record<AppId, (s: number) => React.ReactNode>> = {
  ...
  "app-store": (s) => <svg width={s} height={s} viewBox="0 0 48 48"><rect x="3" y="3" width="42" height="42" rx="10" fill="#00a870"/><rect x="3" y="3" width="42" height="42" rx="10" fill="rgba(255,255,255,0.15)"/><path d="M10 21h28l-3 19H13z" fill="white" opacity="0.95"/><path d="M17 21c0-3.9 3.1-7 7-7s7 3.1 7 7" fill="none" stroke="white" strokeWidth="3.2" strokeLinecap="round"/><rect x="10" y="18" width="28" height="5" rx="2.5" fill="white" opacity="0.92"/><circle cx="19" cy="32" r="2.2" fill="#00a870"/><circle cx="29" cy="32" r="2.2" fill="#00a870"/><ellipse cx="24" cy="21" rx="14" ry="4.5" fill="rgba(255,255,255,0.46)"/></svg>,
...
const APP_ICON_SVGS_P1: Partial<Record<AppId, (s: number) => React.ReactNode>> = {
  ...
  "app-store": (s) => <svg width={s} height={s} viewBox="0 0 48 48"><defs><linearGradient id="xpas1" x1="0%" y1="0%" x2="0%" y2="100%"><stop offset="0%" stopColor="#40c090"/><stop offset="100%" stopColor="#007850"/></linearGradient></defs><rect x="3" y="3" width="42" height="42" rx="7" fill="url(#xpas1)" stroke="#006040" strokeWidth="1.5"/><path d="M10 22h28l-3 18H13z" fill="white" opacity="0.95"/><path d="M17 22c0-3.9 3.1-7 7-7s7 3.1 7 7" fill="none" stroke="white" strokeWidth="3" strokeLinecap="round"/><rect x="10" y="19" width="28" height="5" rx="2.5" fill="white" opacity="0.9"/><circle cx="19" cy="33" r="2.2" fill="#40c090"/><circle cx="29" cy="33" r="2.2" fill="#40c090"/><ellipse cx="24" cy="8" rx="14" ry="4" fill="rgba(255,255,255,0.35)"/></svg>,
