...
const APP_ICON_SVGS: Partial<Record<AppId, (s: number) => React.ReactNode>> = {
  ...
  "pueinet": (s) => <svg width={s} height={s} viewBox="0 0 48 48"><rect x="2" y="6" width="44" height="36" rx="7" fill="#1a4fd8"/><rect x="2" y="6" width="44" height="36" rx="7" fill="rgba(255,255,255,0.1)"/><rect x="6" y="10" width="36" height="9" rx="3.5" fill="rgba(255,255,255,0.22)"/><circle cx="12" cy="14.5" r="3" fill="rgba(255,255,255,0.75)"/><rect x="17" y="12" width="22" height="5" rx="2.5" fill="rgba(255,255,255,0.55)"/><rect x="6" y="23" width="36" height="2.5" rx="1.2" fill="rgba(255,255,255,0.35)"/><rect x="6" y="28" width="26" height="2.5" rx="1.2" fill="rgba(255,255,255,0.28)"/><rect x="6" y="33" width="32" height="2.5" rx="1.2" fill="rgba(255,255,255,0.22)"/><ellipse cx="18" cy="12" rx="14" ry="4" fill="rgba(255,255,255,0.28)"/></svg>,
...
const APP_ICON_SVGS_P1: Partial<Record<AppId, (s: number) => React.ReactNode>> = {
  ...
  "pueinet": (s) => <svg width={s} height={s} viewBox="0 0 48 48"><defs><linearGradient id="xpnet1" x1="0%" y1="0%" x2="0%" y2="100%"><stop offset="0%" stopColor="#6898f8"/><stop offset="100%" stopColor="#1038c8"/></linearGradient></defs><rect x="2" y="6" width="44" height="36" rx="6" fill="url(#xpnet1)" stroke="#0828a8" strokeWidth="1.5"/><rect x="5" y="9" width="38" height="10" rx="3" fill="rgba(255,255,255,0.25)" stroke="rgba(255,255,255,0.4)" strokeWidth="1"/><circle cx="11" cy="14" r="2.8" fill="rgba(255,255,255,0.8)"/><rect x="16" y="11.5" width="22" height="5" rx="2.5" fill="rgba(255,255,255,0.6)"/><rect x="5" y="23" width="38" height="2.5" rx="1.2" fill="rgba(255,255,255,0.4)"/><rect x="5" y="28" width="28" height="2.5" rx="1.2" fill="rgba(255,255,255,0.3)"/><rect x="5" y="33" width="34" height="2.5" rx="1.2" fill="rgba(255,255,255,0.25)"/><ellipse cx="17" cy="11" rx="13" ry="3.5" fill="rgba(255,255,255,0.38)"/></svg>,
...
const APP_ICON_SVGS_P3: Partial<Record<AppId, (s: number) => React.ReactNode>> = {
  ...
  "pueinet": (s) => <svg width={s} height={s} viewBox="0 0 48 48"><rect width="48" height="48" rx="11" fill="#1565c0"/><rect x="7" y="12" width="34" height="9" rx="3.5" fill="rgba(255,255,255,0.22)"/><circle cx="13" cy="16.5" r="3" fill="rgba(255,255,255,0.8)"/><rect x="19" y="14" width="18" height="5" rx="2.5" fill="rgba(255,255,255,0.6)"/><rect x="7" y="26" width="34" height="2.5" rx="1.2" fill="rgba(255,255,255,0.45)"/><rect x="7" y="31" width="22" height="2.5" rx="1.2" fill="rgba(255,255,255,0.35)"/><rect x="7" y="36" width="28" height="2.5" rx="1.2" fill="rgba(255,255,255,0.28)"/></svg>,
