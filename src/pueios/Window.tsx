          ...
          style={{
            ...
            background: fullWindowTransparency
              ...
              : focused
                ...
                : "linear-gradient(135deg, oklch(0.50 0.08 var(--accent-h,220)) 0%, oklch(0.38 0.10 var(--accent-h,220)) 100%)",
            borderBottom: focused
              ? "1px solid color-mix(in oklch, var(--accent) 60%, transparent)"
              : "1px solid rgba(255,255,255,0.10)",
            backdropFilter: fullWindowTransparency ? "blur(12px)" : undefined,
          }}
        >
