...
const APP_ICON_SVGS: Partial<Record<AppId, (s: number) => React.ReactNode>> = {
  ...
  "calculator": (s) => <svg width={s} height={s} viewBox="0 0 48 48"><rect x="5" y="3" width="38" height="43" rx="7" fill="#7278a8"/><rect x="5" y="3" width="38" height="43" rx="7" fill="rgba(255,255,255,0.13)"/><rect x="9" y="7" width="30" height="11" rx="3.5" fill="#30cc30"/><rect x="9" y="7" width="30" height="6" rx="3.5" fill="rgba(255,255,255,0.4)"/><text x="37" y="17" textAnchor="end" fontSize="7.5" fill="#003000" fontFamily="monospace" fontWeight="bold">0</text>{[0,1,2,3].map(r=>[0,1,2,3].map(c=><rect key={`${r}${c}`} x={10+c*7.5} y={22+r*6.5} width="6" height="5" rx="2" fill={r===3&&c===3?"#ee3333":r===0?"#5868a0":"#b0bcdc"} opacity="0.95"/>))}<ellipse cx="24" cy="11" rx="14" ry="4.5" fill="rgba(255,255,255,0.42)"/></svg>,
...
const APP_ICON_SVGS_P1: Partial<Record<AppId, (s: number) => React.ReactNode>> = {
  ...
  "app-store": (s) => <svg width={s} height={s} viewBox="0 0 48 48"><rect x="4" y="4" width="40" height="40" rx="5" fill="none" stroke="#08a" strokeWidth="2.5"/><path d="M11 21h26l-3 18H14z" fill="#08a"/><path d="M17 21c0-3.9 3.1-7 7-7s7 3.1 7 7" fill="none" stroke="#08a" strokeWidth="2.5" strokeLinecap="round"/><rect x="11" y="18" width="26" height="5" rx="2.5" fill="#08a"/></svg>,
