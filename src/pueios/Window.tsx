...
// macOS Panther-style icons — aqua gel, no <defs> gradients to avoid ID collisions
const APP_ICON_SVGS: Partial<Record<AppId, (s: number) => React.ReactNode>> = {
  "settings": (s) => <svg width={s} height={s} viewBox="0 0 48 48"><circle cx="24" cy="24" r="22" fill="#8898b8"/><circle cx="24" cy="24" r="22" fill="rgba(255,255,255,0.18)"/><path d="M24 4l3 6 6-1 2 5-5 4 1 6-5 3-5-3 1-6-5-4 2-5 6 1z" fill="#c8d0e8"/><circle cx="24" cy="24" r="7" fill="#3878d8"/><circle cx="24" cy="24" r="7" fill="rgba(255,255,255,0.25)"/><ellipse cx="21" cy="10" rx="9" ry="3.5" fill="rgba(255,255,255,0.5)"/></svg>,
  "file-explorer": (s) => <svg width={s} height={s} viewBox="0 0 48 48"><rect x="3" y="5" width="42" height="28" rx="5" fill="#4488cc"/><rect x="3" y="5" width="42" height="28" rx="5" fill="rgba(255,255,255,0.15)"/><rect x="6" y="8" width="36" height="22" rx="2" fill="#1a4a8a"/><rect x="8" y="10" width="32" height="18" rx="1.5" fill="#ddeeff"/><rect x="11" y="13" width="10" height="7" rx="2" fill="white" opacity="0.9"/><rect x="23" y="13" width="14" height="3" rx="1.5" fill="white" opacity="0.7"/><rect x="23" y="18" width="10" height="2.5" rx="1.2" fill="white" opacity="0.5"/><rect x="20" y="33" width="8" height="5" rx="1.5" fill="#5588bb"/><rect x="14" y="37" width="20" height="3.5" rx="2" fill="#3366aa"/><ellipse cx="24" cy="10" rx="18" ry="5" fill="rgba(255,255,255,0.35)"/></svg>,
  "notepad": (s) => <svg width={s} height={s} viewBox="0 0 48 48"><rect x="7" y="3" width="34" height="42" rx="3" fill="#e8eeff"/><rect x="7" y="3" width="34" height="42" rx="3" fill="rgba(255,255,255,0.4)"/><line x1="16" y1="3" x2="16" y2="45" stroke="#ff8888" strokeWidth="2.5"/><line x1="7" y1="14" x2="41" y2="14" stroke="#99bbee" strokeWidth="1.5"/><line x1="7" y1="20" x2="41" y2="20" stroke="#99bbee" strokeWidth="1.5"/><line x1="7" y1="26" x2="41" y2="26" stroke="#99bbee" strokeWidth="1.5"/><line x1="7" y1="32" x2="41" y2="32" stroke="#99bbee" strokeWidth="1.5"/><line x1="7" y1="38" x2="41" y2="38" stroke="#99bbee" strokeWidth="1.5"/><ellipse cx="24" cy="11" rx="14" ry="5" fill="rgba(255,255,255,0.6)"/></svg>,
  "calculator": (s) => <svg width={s} height={s} viewBox="0 0 48 48"><rect x="6" y="3" width="36" height="42" rx="6" fill="#9098b8"/><rect x="6" y="3" width="36" height="42" rx="6" fill="rgba(255,255,255,0.15)"/><rect x="10" y="7" width="28" height="10" rx="3" fill="#44cc44"/><rect x="10" y="7" width="28" height="5" rx="3" fill="rgba(255,255,255,0.4)"/><text x="36" y="16" textAnchor="end" fontSize="7" fill="#002800" fontFamily="monospace" fontWeight="bold">0</text>{[0,1,2,3].map(r=>[0,1,2,3].map(c=><rect key={`${r}-${c}`} x={10+c*7} y={21+r*6} width="5.5" height="4.5" rx="1.5" fill={r===3&&c===3?"#ee4444":r===0?"#7080a8":"#c0c8e0"} opacity="0.95"/>))}<ellipse cx="24" cy="11" rx="14" ry="4" fill="rgba(255,255,255,0.35)"/></svg>,
  "puei-paint": (s) => <svg width={s} height={s} viewBox="0 0 48 48"><ellipse cx="22" cy="26" rx="18" ry="14" fill="#e8e0b8"/><ellipse cx="22" cy="26" rx="18" ry="14" fill="rgba(255,255,255,0.25)"/><circle cx="12" cy="24" r="5" fill="#ee2222"/><circle cx="20" cy="16" r="5" fill="#22cc22"/><circle cx="30" cy="18" r="5" fill="#2244ff"/><circle cx="32" cy="30" r="5" fill="#ffcc00"/><circle cx="16" cy="32" r="5" fill="#cc22cc"/><circle cx="12" cy="24" r="2.5" fill="rgba(255,255,255,0.6)"/><circle cx="20" cy="16" r="2.5" fill="rgba(255,255,255,0.6)"/><circle cx="30" cy="18" r="2.5" fill="rgba(255,255,255,0.6)"/><path d="M36 8 Q42 4 44 12 Q46 19 40 20 L36 18 Q32 13 36 8z" fill="#cc7010"/><rect x="38" y="20" width="4" height="13" rx="2" fill="#ddaa44" transform="rotate(18 40 20)"/><ellipse cx="15" cy="18" rx="13" ry="5" fill="rgba(255,255,255,0.55)" transform="rotate(-15 15 18)"/></svg>,
  "puei-board": (s) => <svg width={s} height={s} viewBox="0 0 48 48"><rect x="4" y="4" width="40" height="40" rx="5" fill="#b88848"/><rect x="4" y="4" width="40" height="40" rx="5" fill="rgba(255,255,255,0.12)"/><rect x="10" y="10" width="12" height="10" rx="2" fill="white" opacity="0.95"/><rect x="26" y="10" width="12" height="8" rx="2" fill="#ffff88" opacity="0.97"/><rect x="26" y="22" width="12" height="10" rx="2" fill="#ffbbbb" opacity="0.97"/><rect x="10" y="24" width="12" height="16" rx="2" fill="#bbffbb" opacity="0.97"/><circle cx="16" cy="10" r="2.5" fill="#ee0000"/><circle cx="32" cy="10" r="2.5" fill="#00aa00"/><circle cx="32" cy="22" r="2.5" fill="#0022ee"/><ellipse cx="24" cy="12" rx="18" ry="5" fill="rgba(255,255,255,0.35)"/></svg>,
  "pueinet": (s) => <svg width={s} height={s} viewBox="0 0 48 48"><rect x="2" y="5" width="44" height="38" rx="5" fill="#1155cc"/><rect x="2" y="5" width="44" height="38" rx="5" fill="rgba(255,255,255,0.12)"/><rect x="2" y="5" width="44" height="12" rx="5" fill="#ddeeff"/><rect x="2" y="13" width="44" height="4" fill="#ddeeff"/><circle cx="9" cy="11" r="3" fill="#ff4444"/><circle cx="17" cy="11" r="3" fill="#ffcc00"/><circle cx="25" cy="11" r="3" fill="#44dd44"/><rect x="29" y="8" width="14" height="6" rx="3" fill="rgba(255,255,255,0.35)"/><rect x="7" y="22" width="34" height="3" rx="1.5" fill="rgba(255,255,255,0.7)"/><rect x="7" y="27" width="24" height="3" rx="1.5" fill="rgba(255,255,255,0.5)"/><rect x="7" y="32" width="30" height="3" rx="1.5" fill="rgba(255,255,255,0.4)"/><rect x="7" y="37" width="18" height="3" rx="1.5" fill="rgba(255,255,255,0.3)"/><ellipse cx="24" cy="11" rx="20" ry="5" fill="rgba(255,255,255,0.4)"/></svg>,
  "puei-cloud-chat": (s) => <svg width={s} height={s} viewBox="0 0 48 48"><path d="M6 10a4 4 0 014-4h28a4 4 0 014 4v18a4 4 0 01-4 4H28l-8 8v-8H10a4 4 0 01-4-4V10z" fill="#22aa22"/><path d="M6 10a4 4 0 014-4h28a4 4 0 014 4v18a4 4 0 01-4 4H28l-8 8v-8H10a4 4 0 01-4-4V10z" fill="rgba(255,255,255,0.15)"/><rect x="11" y="12" width="26" height="3" rx="1.5" fill="rgba(255,255,255,0.95)"/><rect x="11" y="18" width="18" height="3" rx="1.5" fill="rgba(255,255,255,0.95)"/><rect x="11" y="24" width="22" height="3" rx="1.5" fill="rgba(255,255,255,0.95)"/><ellipse cx="24" cy="8" rx="18" ry="5" fill="rgba(255,255,255,0.4)"/></svg>,
  "puei-studio": (s) => <svg width={s} height={s} viewBox="0 0 48 48"><circle cx="24" cy="24" r="21" fill="#8822cc"/><circle cx="24" cy="24" r="21" fill="rgba(255,255,255,0.15)"/><path d="M24 10 L27 19 H37 L29 25 L32 34 L24 28 L16 34 L19 25 L11 19 H21 Z" fill="#ffee44"/><ellipse cx="17" cy="13" rx="12" ry="5" fill="rgba(255,255,255,0.45)" transform="rotate(-20 17 13)"/></svg>,
  "app-store": (s) => <svg width={s} height={s} viewBox="0 0 48 48"><rect x="4" y="4" width="40" height="40" rx="9" fill="#00aa88"/><rect x="4" y="4" width="40" height="40" rx="9" fill="rgba(255,255,255,0.15)"/><path d="M24 9 L27 18 H37 L29 24 L32 33 L24 27 L16 33 L19 24 L11 18 H21 Z" fill="#ffff44"/><ellipse cx="24" cy="16" rx="16" ry="6" fill="rgba(255,255,255,0.4)"/></svg>,
  "puei-social": (s) => <svg width={s} height={s} viewBox="0 0 48 48"><circle cx="17" cy="16" r="8" fill="#ee8822"/><circle cx="17" cy="16" r="8" fill="rgba(255,255,255,0.2)"/><path d="M2 42c0-9 7-14 15-14s15 5 15 14z" fill="#ee8822"/><path d="M2 42c0-9 7-14 15-14s15 5 15 14z" fill="rgba(255,255,255,0.12)"/><circle cx="17" cy="12" r="5" fill="rgba(255,255,255,0.45)"/><circle cx="33" cy="14" r="7" fill="#3366dd"/><circle cx="33" cy="14" r="7" fill="rgba(255,255,255,0.2)"/><path d="M24 40c0-7 5-11 11-11s11 4 11 11z" fill="#3366dd"/><circle cx="33" cy="10" r="4" fill="rgba(255,255,255,0.45)"/></svg>,
  "folder": (s) => <svg width={s} height={s} viewBox="0 0 48 48"><path d="M4 18a3 3 0 013-3h8l4 3h22a3 3 0 013 3v14a3 3 0 01-3 3H7a3 3 0 01-3-3V18z" fill="#f8a800"/><path d="M4 18a3 3 0 013-3h8l4 3h22a3 3 0 013 3v14a3 3 0 01-3 3H7a3 3 0 01-3-3V18z" fill="rgba(255,255,255,0.15)"/><path d="M4 16a3 3 0 013-3h8l4 3z" fill="#d08800"/><ellipse cx="22" cy="19" rx="14" ry="4" fill="rgba(255,255,255,0.55)"/></svg>,
  "recycle-bin": (s) => <svg width={s} height={s} viewBox="0 0 48 48"><path d="M10 18h28l-3 24H13z" fill="#b0bcc8"/><path d="M10 18h28l-3 24H13z" fill="rgba(255,255,255,0.2)"/><path d="M6 14h36" stroke="#606878" strokeWidth="3" strokeLinecap="round"/><path d="M16 14V10h16v4" fill="none" stroke="#606878" strokeWidth="2.5"/><path d="M19 27 L24 22 L29 27" fill="none" stroke="#22aa22" strokeWidth="3" strokeLinecap="round" strokeLinejoin="round"/><path d="M24 22 v9" stroke="#22aa22" strokeWidth="3" strokeLinecap="round"/><ellipse cx="24" cy="22" rx="16" ry="5" fill="rgba(255,255,255,0.4)"/></svg>,
  "chess": (s) => <svg width={s} height={s} viewBox="0 0 48 48"><rect x="4" y="4" width="40" height="40" rx="5" fill="#d8a850"/><rect x="4" y="4" width="40" height="40" rx="5" fill="rgba(255,255,255,0.1)"/>{[0,1,2,3,4].map(r=>[0,1,2,3,4].map(c=>(r+c)%2===0?<rect key={`${r}-${c}`} x={4+c*8} y={4+r*8} width="8" height="8" fill="#a07030"/>:null))}<path d="M20 34v-4l-2-3 1-2 2-1 3-1 2 1 2 3-1 4v4z" fill="white"/><rect x="17" y="34" width="10" height="3" rx="1.5" fill="white"/><ellipse cx="24" cy="25" rx="8" ry="3" fill="rgba(255,255,255,0.45)"/></svg>,
  "puei-mansion": (s) => <svg width={s} height={s} viewBox="0 0 48 48"><polygon points="24,4 44,20 40,20 40,44 8,44 8,20 4,20" fill="#cc2828"/><polygon points="24,4 44,20 40,20 40,44 8,44 8,20 4,20" fill="rgba(255,255,255,0.12)"/><rect x="10" y="20" width="28" height="24" fill="#f0ece0"/><rect x="18" y="30" width="12" height="14" rx="1" fill="#88bbff"/><rect x="12" y="23" width="8" height="8" rx="1" fill="#88bbff"/><rect x="28" y="23" width="8" height="8" rx="1" fill="#88bbff"/><ellipse cx="24" cy="11" rx="14" ry="5" fill="rgba(255,120,120,0.55)"/></svg>,
  "about": (s) => <svg width={s} height={s} viewBox="0 0 48 48"><circle cx="24" cy="24" r="21" fill="#2255cc"/><circle cx="24" cy="24" r="21" fill="rgba(255,255,255,0.15)"/><circle cx="24" cy="15" r="3.5" fill="white"/><rect x="21" y="21" width="6" height="13" rx="3" fill="white"/><ellipse cx="17" cy="13" rx="12" ry="5" fill="rgba(255,255,255,0.45)" transform="rotate(-25 17 13)"/></svg>,
  "task-manager": (s) => <svg width={s} height={s} viewBox="0 0 48 48"><rect x="4" y="4" width="40" height="40" rx="5" fill="#506070"/><rect x="4" y="4" width="40" height="40" rx="5" fill="rgba(255,255,255,0.1)"/><rect x="8" y="9" width="32" height="5" rx="2.5" fill="rgba(255,255,255,0.15)"/><rect x="8" y="9" width="22" height="5" rx="2.5" fill="#4499ff"/><rect x="8" y="17" width="32" height="5" rx="2.5" fill="rgba(255,255,255,0.15)"/><rect x="8" y="17" width="18" height="5" rx="2.5" fill="#44dd66"/><rect x="8" y="25" width="32" height="5" rx="2.5" fill="rgba(255,255,255,0.15)"/><rect x="8" y="25" width="12" height="5" rx="2.5" fill="#ff6633"/><rect x="8" y="33" width="32" height="5" rx="2.5" fill="rgba(255,255,255,0.15)"/><rect x="8" y="33" width="27" height="5" rx="2.5" fill="#ffcc22"/><ellipse cx="24" cy="12" rx="18" ry="4.5" fill="rgba(255,255,255,0.3)"/></svg>,
  "iso-viewer": (s) => <svg width={s} height={s} viewBox="0 0 48 48"><circle cx="24" cy="24" r="21" fill="#c0c8e8"/><circle cx="24" cy="24" r="21" fill="rgba(255,255,255,0.2)"/><circle cx="24" cy="24" r="13" fill="#9090c0"/><circle cx="24" cy="24" r="13" fill="rgba(255,255,255,0.15)"/><circle cx="24" cy="24" r="5" fill="#c8d0e8"/><circle cx="24" cy="24" r="2.5" fill="white"/><ellipse cx="17" cy="14" rx="10" ry="4.5" fill="rgba(255,255,255,0.6)" transform="rotate(-30 17 14)"/></svg>,
  "zip-viewer": (s) => <svg width={s} height={s} viewBox="0 0 48 48"><path d="M6 10a3 3 0 013-3h20l8 8v26a3 3 0 01-3 3H9a3 3 0 01-3-3V10z" fill="#3377cc"/><path d="M6 10a3 3 0 013-3h20l8 8v26a3 3 0 01-3 3H9a3 3 0 01-3-3V10z" fill="rgba(255,255,255,0.15)"/><path d="M29 7v8h8" fill="none" stroke="#2255aa" strokeWidth="1.5"/><rect x="20" y="16" width="8" height="3" rx="1.5" fill="white" opacity="0.9"/><rect x="20" y="21" width="8" height="3" rx="1.5" fill="#aaccff" opacity="0.9"/><rect x="20" y="26" width="8" height="3" rx="1.5" fill="white" opacity="0.9"/><rect x="20" y="31" width="8" height="3" rx="1.5" fill="#aaccff" opacity="0.9"/><rect x="20" y="36" width="8" height="3" rx="1.5" fill="white" opacity="0.9"/><ellipse cx="20" cy="14" rx="12" ry="4" fill="rgba(255,255,255,0.35)"/></svg>,
  "pmail": (s) => <svg width={s} height={s} viewBox="0 0 48 48"><rect x="4" y="10" width="40" height="28" rx="5" fill="#ddeeff"/><rect x="4" y="10" width="40" height="28" rx="5" fill="rgba(255,255,255,0.3)"/><path d="M4 13l20 15 20-15" fill="none" stroke="#2255bb" strokeWidth="2.5"/><ellipse cx="24" cy="18" rx="18" ry="6" fill="rgba(255,255,255,0.5)"/></svg>,
  "web-app": (s) => <svg width={s} height={s} viewBox="0 0 48 48"><rect x="3" y="6" width="42" height="36" rx="5" fill="#2255bb"/><rect x="3" y="6" width="42" height="36" rx="5" fill="rgba(255,255,255,0.12)"/><rect x="3" y="6" width="42" height="13" rx="5" fill="#eef4ff"/><rect x="3" y="14" width="42" height="5" fill="#eef4ff"/><circle cx="10" cy="12" r="3.5" fill="#ff4444"/><circle cx="19" cy="12" r="3.5" fill="#ffcc00"/><circle cx="28" cy="12" r="3.5" fill="#44cc44"/><rect x="33" y="9" width="10" height="6" rx="3" fill="rgba(255,255,255,0.4)"/><rect x="8" y="26" width="32" height="3" rx="1.5" fill="rgba(255,255,255,0.6)"/><rect x="8" y="32" width="22" height="3" rx="1.5" fill="rgba(255,255,255,0.4)"/><rect x="8" y="38" width="28" height="3" rx="1.5" fill="rgba(255,255,255,0.3)"/><ellipse cx="24" cy="12" rx="18" ry="5" fill="rgba(255,255,255,0.4)"/></svg>,
  "pueyracing": (s) => <svg width={s} height={s} viewBox="0 0 48 48"><rect width="48" height="48" fill="#0a1440"/><circle cx="8" cy="8" r="1.2" fill="white" opacity="0.9"/><circle cx="38" cy="6" r="1.5" fill="white" opacity="0.8"/><circle cx="14" cy="36" r="0.9" fill="white" opacity="0.7"/><circle cx="42" cy="30" r="1.2" fill="white" opacity="0.9"/><circle cx="6" cy="22" r="0.8" fill="white" opacity="0.6"/><circle cx="30" cy="40" r="1" fill="white" opacity="0.8"/><path d="M24 7 C24 7 16 17 16 28 L20 30 L24 32 L28 30 L32 28 C32 17 24 7 24 7z" fill="#c0d0f0"/><ellipse cx="24" cy="19" rx="5" ry="6.5" fill="#88ccff" opacity="0.9"/><path d="M16 28 L9 34 L13 32 L16 32z" fill="#5060a0"/><path d="M32 28 L39 34 L35 32 L32 32z" fill="#5060a0"/><ellipse cx="24" cy="34" rx="4.5" ry="2.5" fill="#ff9030"/><ellipse cx="24" cy="38" rx="3.5" ry="6" fill="#ff4800" opacity="0.9"/><ellipse cx="21" cy="13" rx="4" ry="6" fill="rgba(255,255,255,0.55)" transform="rotate(-15 21 13)"/></svg>,
};
...
const APP_ICON_SVGS_P1: Partial<Record<AppId, (s: number) => React.ReactNode>> = {
  ...
  "file-explorer": (s) => <svg width={s} height={s} viewBox="0 0 48 48"><rect x="4" y="5" width="40" height="28" rx="3" fill="#cce4f8" stroke="#5a9fd4" strokeWidth="2"/><rect x="7" y="8" width="34" height="22" rx="1.5" fill="#87c0ea"/><rect x="18" y="33" width="12" height="5" rx="1" fill="#b0b8c8"/><rect x="13" y="37" width="22" height="3" rx="1.5" fill="#8090a8"/><rect x="10" y="11" width="28" height="16" rx="1" fill="#e8f4fc"/><rect x="13" y="14" width="8" height="7" rx="1" fill="#fff" stroke="#aacce8" strokeWidth="1"/><rect x="24" y="14" width="11" height="3" rx="1" fill="#c8dcf0"/><rect x="24" y="19" width="7" height="2" rx="1" fill="#c8dcf0"/></svg>,
  ...
  "pueinet": (s) => <svg width={s} height={s} viewBox="0 0 48 48"><rect x="2" y="5" width="44" height="38" rx="3" fill="white" stroke="#48c" strokeWidth="2"/><rect x="2" y="5" width="44" height="10" rx="3" fill="#48c"/><circle cx="8" cy="10" r="2" fill="white" opacity="0.7"/><circle cx="14" cy="10" r="2" fill="white" opacity="0.7"/><rect x="19" y="7.5" width="20" height="5" rx="2.5" fill="rgba(255,255,255,0.25)"/><rect x="8" y="20" width="32" height="2.5" rx="1.2" fill="#cce"/><rect x="8" y="26" width="22" height="2.5" rx="1.2" fill="#cce"/><rect x="8" y="32" width="28" height="2.5" rx="1.2" fill="#cce"/></svg>,
...
const APP_ICON_SVGS_P3: Partial<Record<AppId, (s: number) => React.ReactNode>> = {
  ...
  "pueinet": (s) => <svg width={s} height={s} viewBox="0 0 48 48"><rect width="48" height="48" rx="11" fill="#1e88e5"/><rect x="5" y="9" width="38" height="30" rx="4" fill="white"/><rect x="5" y="9" width="38" height="10" rx="4" fill="#bbdefb"/><rect x="5" y="15" width="38" height="4" fill="#bbdefb"/><circle cx="11" cy="14" r="2.2" fill="#ef5350"/><circle cx="16.5" cy="14" r="2.2" fill="#fdd835"/><circle cx="22" cy="14" r="2.2" fill="#66bb6a"/><rect x="25" y="11.5" width="14" height="5" rx="2.5" fill="rgba(30,136,229,0.18)"/><rect x="10" y="23" width="28" height="2.5" rx="1.2" fill="#bbdefb"/><rect x="10" y="28" width="20" height="2.5" rx="1.2" fill="#e3f2fd"/><rect x="10" y="33" width="24" height="2.5" rx="1.2" fill="#e3f2fd"/></svg>,
