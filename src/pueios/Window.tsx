...
const APP_ICON_SVGS: Partial<Record<AppId, (s: number) => React.ReactNode>> = {
  ...
  "pueinet": (s) => <svg width={s} height={s} viewBox="0 0 48 48"><defs><radialGradient id="pwebBg" cx="40%" cy="30%" r="70%"><stop offset="0%" stopColor="#38bdf8"/><stop offset="55%" stopColor="#2563eb"/><stop offset="100%" stopColor="#1e1b72"/></radialGradient></defs><circle cx="24" cy="24" r="22" fill="url(#pwebBg)"/><path d="M14 34 Q10 24 14 14 Q20 6 28 8 Q36 10 38 18 Q40 26 34 32 Q28 38 20 36 Z" fill="none" stroke="rgba(255,255,255,0.18)" strokeWidth="1.5"/><path d="M24 6 C14 6 6 14 6 24 C6 34 14 42 24 42" stroke="rgba(255,255,255,0.22)" strokeWidth="1.5" fill="none"/><path d="M32 10 Q42 18 40 28 Q38 36 30 40" stroke="rgba(255,255,255,0.22)" strokeWidth="1.5" fill="none"/><path d="M13 30 C15 18 22 10 32 9 L38 16 C30 15 22 20 18 30 Z" fill="rgba(255,255,255,0.75)"/><path d="M18 30 C20 22 26 16 35 15 L38 16 C30 15 22 20 18 30 Z" fill="white"/><circle cx="36" cy="15" r="5" fill="#facc15"/><circle cx="36" cy="15" r="3" fill="white"/><ellipse cx="20" cy="10" rx="9" ry="3" fill="rgba(255,255,255,0.4)" transform="rotate(-20 20 10)"/></svg>,
...
const APP_ICON_SVGS_P1: Partial<Record<AppId, (s: number) => React.ReactNode>> = {
  ...
  "pueinet": (s) => <svg width={s} height={s} viewBox="0 0 48 48"><defs><radialGradient id="xpnet1" cx="40%" cy="30%" r="70%"><stop offset="0%" stopColor="#60c8f8"/><stop offset="55%" stopColor="#1e60e8"/><stop offset="100%" stopColor="#100858"/></radialGradient></defs><circle cx="24" cy="24" r="22" fill="url(#xpnet1)" stroke="#0828a8" strokeWidth="1.2"/><path d="M13 30 C15 18 22 10 32 9 L38 16 C30 15 22 20 18 30 Z" fill="rgba(255,255,255,0.72)"/><path d="M18 30 C20 22 26 16 35 15 L38 16 C30 15 22 20 18 30 Z" fill="white"/><circle cx="36" cy="15" r="5" fill="#fde047" stroke="#facc15" strokeWidth="0.8"/><circle cx="36" cy="15" r="2.8" fill="white"/><ellipse cx="20" cy="10" rx="9" ry="3" fill="rgba(255,255,255,0.42)" transform="rotate(-20 20 10)"/></svg>,
...
const APP_ICON_SVGS_P3: Partial<Record<AppId, (s: number) => React.ReactNode>> = {
  ...
  "pueinet": (s) => <svg width={s} height={s} viewBox="0 0 48 48"><defs><linearGradient id="pwebP3" x1="0%" y1="0%" x2="100%" y2="100%"><stop offset="0%" stopColor="#38bdf8"/><stop offset="100%" stopColor="#1d4ed8"/></linearGradient></defs><rect width="48" height="48" rx="11" fill="url(#pwebP3)"/><path d="M13 30 C15 18 22 10 32 9 L38 16 C30 15 22 20 18 30 Z" fill="rgba(255,255,255,0.7)"/><path d="M18 30 C20 22 26 16 35 15 L38 16 C30 15 22 20 18 30 Z" fill="white"/><circle cx="36" cy="15" r="5" fill="#fde047"/><circle cx="36" cy="15" r="2.8" fill="white"/></svg>,
