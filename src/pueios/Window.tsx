...
const APP_ICON_SVGS: Partial<Record<AppId, (s: number) => React.ReactNode>> = {
  ...
  "notepad": (s) => <svg width={s} height={s} viewBox="0 0 48 48"><rect x="6" y="3" width="36" height="43" rx="4" fill="#e4ecff"/><rect x="6" y="3" width="36" height="43" rx="4" fill="rgba(255,255,255,0.35)"/><line x1="16" y1="3" x2="16" y2="46" stroke="#ff7070" strokeWidth="2.5"/><line x1="13" y1="3" x2="13" y2="46" stroke="#ffb8b8" strokeWidth="1.2"/>{[13,19,25,31,37,43].map(y=><line key={y} x1="6" x2="42" y1={y} y2={y} stroke="#a0bef0" strokeWidth="1.2"/>)}<ellipse cx="24" cy="10" rx="15" ry="5" fill="rgba(255,255,255,0.68)"/></svg>,
  "calculator": (s) => <svg width={s} height={s} viewBox="0 0 48 48"><rect x="4" y="2" width="40" height="44" rx="7" fill="#6870a0"/><rect x="4" y="2" width="40" height="44" rx="7" fill="rgba(255,255,255,0.13)"/><rect x="8" y="6" width="32" height="10" rx="3" fill="#2ecc2e"/><rect x="8" y="6" width="32" height="5" rx="3" fill="rgba(255,255,255,0.4)"/><text x="38" y="15.5" textAnchor="end" fontSize="7" fill="#003000" fontFamily="monospace" fontWeight="bold">0</text>{[0,1,2,3].map(r=>[0,1,2,3].map(c=><rect key={`${r}${c}`} x={9+c*8} y={20+r*6} width="6" height="5" rx="1.5" fill={r===3&&c===3?"#ee3333":r===0?"#5060a0":"#aab8dc"} opacity="0.95"/>))}<ellipse cx="24" cy="10" rx="14" ry="4" fill="rgba(255,255,255,0.42)"/></svg>,
  ...
  "pueinet": (s) => <svg width={s} height={s} viewBox="0 0 48 48"><rect x="2" y="5" width="44" height="38" rx="6" fill="#1040cc"/><rect x="2" y="5" width="44" height="38" rx="6" fill="rgba(255,255,255,0.1)"/><rect x="2" y="5" width="44" height="13" rx="6" fill="#dce8ff"/><rect x="2" y="13" width="44" height="5" fill="#dce8ff"/><circle cx="9" cy="11.5" r="3.2" fill="#ff3333"/><circle cx="18" cy="11.5" r="3.2" fill="#ffcc00"/><circle cx="27" cy="11.5" r="3.2" fill="#33dd33"/><rect x="32" y="8" width="12" height="7" rx="3.5" fill="rgba(16,64,204,0.2)"/>{[22,28,34,40].map((y,i)=><rect key={y} x="7" y={y} width={[34,24,30,18][i]} height="3" rx="1.5" fill={`rgba(255,255,255,${0.68-i*0.1})`}/>)}<ellipse cx="24" cy="11" rx="20" ry="5.5" fill="rgba(255,255,255,0.48)"/></svg>,
  "puei-cloud-chat": (s) => <svg width={s} height={s} viewBox="0 0 48 48"><path d="M5 9a5 5 0 015-5h28a5 5 0 015 5v18a5 5 0 01-5 5H28l-8 9v-9H10a5 5 0 01-5-5z" fill="#159015"/><path d="M5 9a5 5 0 015-5h28a5 5 0 015 5v18a5 5 0 01-5 5H28l-8 9v-9H10a5 5 0 01-5-5z" fill="rgba(255,255,255,0.16)"/><rect x="11" y="11" width="26" height="3.5" rx="1.75" fill="rgba(255,255,255,0.95)"/><rect x="11" y="18" width="19" height="3.5" rx="1.75" fill="rgba(255,255,255,0.95)"/><rect x="11" y="25" width="23" height="3.5" rx="1.75" fill="rgba(255,255,255,0.95)"/><ellipse cx="24" cy="7" rx="18" ry="5" fill="rgba(255,255,255,0.44)"/></svg>,
  "puei-studio": (s) => <svg width={s} height={s} viewBox="0 0 48 48"><circle cx="24" cy="24" r="22" fill="#7711cc"/><circle cx="24" cy="24" r="22" fill="rgba(255,255,255,0.14)"/><path d="M24 9 L27.5 18.5 H38 L29.5 24.5 L33 34 L24 28 L15 34 L18.5 24.5 L10 18.5 H20.5 Z" fill="#ffee44"/><path d="M24 9 L27.5 18.5 H38 L29.5 24.5 L33 34 L24 28 L15 34 L18.5 24.5 L10 18.5 H20.5 Z" fill="rgba(255,255,255,0.1)"/><ellipse cx="17" cy="12" rx="12" ry="5" fill="rgba(255,255,255,0.5)" transform="rotate(-22 17 12)"/></svg>,
  "app-store": (s) => <svg width={s} height={s} viewBox="0 0 48 48"><rect x="2" y="2" width="44" height="44" rx="10" fill="#1a7fe8"/><rect x="2" y="2" width="44" height="44" rx="10" fill="rgba(255,255,255,0.18)"/><rect x="2" y="2" width="44" height="22" rx="10" fill="rgba(255,255,255,0.22)"/><path d="M16 22h16l-2 14H18z" fill="white" opacity="0.97"/><path d="M20 22c0-2.8 1.8-5 4-5s4 2.2 4 5" fill="none" stroke="white" strokeWidth="2.8" strokeLinecap="round"/><rect x="14" y="19.5" width="20" height="4.5" rx="2.2" fill="white" opacity="0.95"/><circle cx="21" cy="29" r="1.8" fill="#1a7fe8"/><circle cx="27" cy="29" r="1.8" fill="#1a7fe8"/><ellipse cx="24" cy="10" rx="14" ry="5" fill="rgba(255,255,255,0.55)"/></svg>,
  ...
  "pmail": (s) => <svg width={s} height={s} viewBox="0 0 48 48"><rect x="3" y="10" width="42" height="30" rx="6" fill="#c8dcff"/><rect x="3" y="10" width="42" height="30" rx="6" fill="rgba(255,255,255,0.28)"/><path d="M3 14l21 16 21-16" fill="none" stroke="#1040bb" strokeWidth="3" strokeLinejoin="round"/><ellipse cx="24" cy="18" rx="19" ry="6.5" fill="rgba(255,255,255,0.58)"/></svg>,
  ...
  "computer": (s) => <svg width={s} height={s} viewBox="0 0 48 48"><rect x="4" y="4" width="40" height="28" rx="4" fill="#2050b0"/><rect x="4" y="4" width="40" height="28" rx="4" fill="rgba(255,255,255,0.12)"/><rect x="7" y="7" width="34" height="22" rx="2" fill="#c0d8ff"/><rect x="8" y="8" width="32" height="20" rx="1.5" fill="#e8f0ff"/><rect x="10" y="10" width="14" height="10" rx="1" fill="white" opacity="0.8"/><rect x="26" y="10" width="12" height="3" rx="1" fill="#90b8e8" opacity="0.8"/><rect x="26" y="15" width="8" height="2.5" rx="1" fill="#90b8e8" opacity="0.6"/><rect x="18" y="32" width="12" height="5" rx="1" fill="#7090c0"/><rect x="14" y="37" width="20" height="3" rx="1.5" fill="#5070a8"/><ellipse cx="24" cy="8" rx="14" ry="4" fill="rgba(255,255,255,0.5)"/></svg>,
  "computer": (s) => <svg width={s} height={s} viewBox="0 0 48 48"><rect x="3" y="3" width="42" height="28" rx="5" fill="#2050b8"/><rect x="3" y="3" width="42" height="28" rx="5" fill="rgba(255,255,255,0.14)"/><rect x="6" y="6" width="36" height="22" rx="3" fill="#c8e0ff"/><rect x="7" y="7" width="34" height="20" rx="2" fill="#e8f4ff"/><rect x="9" y="9" width="14" height="10" rx="1.5" fill="white" opacity="0.88"/><rect x="25" y="9" width="13" height="3.5" rx="1.5" fill="rgba(60,120,220,0.4)"/><rect x="25" y="14" width="9" height="2.5" rx="1.2" fill="rgba(60,120,220,0.3)"/><rect x="18" y="31" width="12" height="5" rx="1.5" fill="#3060b0"/><rect x="14" y="36" width="20" height="3" rx="1.5" fill="#2050a0"/><ellipse cx="24" cy="7" rx="15" ry="4" fill="rgba(255,255,255,0.55)"/></svg>,
...
const APP_ICON_SVGS_P1: Partial<Record<AppId, (s: number) => React.ReactNode>> = {
  ...
  "notepad": (s) => <svg width={s} height={s} viewBox="0 0 48 48"><defs><linearGradient id="xpnp1" x1="0%" y1="0%" x2="100%" y2="100%"><stop offset="0%" stopColor="#ffffff"/><stop offset="100%" stopColor="#d8ddf0"/></linearGradient></defs><rect x="7" y="3" width="34" height="42" rx="2" fill="url(#xpnp1)" stroke="#8898c8" strokeWidth="1.5"/><rect x="7" y="3" width="34" height="7" rx="2" fill="#4a6db8"/><rect x="7" y="7" width="34" height="3" fill="#4a6db8"/><line x1="13" y1="3" x2="13" y2="45" stroke="#f88" strokeWidth="1.5"/><line x1="7" y1="16" x2="41" y2="16" stroke="#c8cce8" strokeWidth="1"/><line x1="7" y1="22" x2="41" y2="22" stroke="#c8cce8" strokeWidth="1"/><line x1="7" y1="28" x2="41" y2="28" stroke="#c8cce8" strokeWidth="1"/><line x1="7" y1="34" x2="41" y2="34" stroke="#c8cce8" strokeWidth="1"/><line x1="7" y1="40" x2="41" y2="40" stroke="#c8cce8" strokeWidth="1"/><ellipse cx="24" cy="5" rx="10" ry="2" fill="rgba(255,255,255,0.4)"/></svg>,
  "calculator": (s) => <svg width={s} height={s} viewBox="0 0 48 48"><defs><linearGradient id="xpcalc1" x1="0%" y1="0%" x2="0%" y2="100%"><stop offset="0%" stopColor="#d8dde8"/><stop offset="100%" stopColor="#9098b0"/></linearGradient></defs><rect x="5" y="3" width="38" height="42" rx="5" fill="url(#xpcalc1)" stroke="#6878a0" strokeWidth="1.5"/><rect x="9" y="7" width="30" height="9" rx="3" fill="#c8f0c8" stroke="#60a860" strokeWidth="1"/><text x="37" y="15" textAnchor="end" fontSize="7" fill="#004000" fontFamily="monospace" fontWeight="bold">0</text>{[0,1,2,3].map(r=>[0,1,2,3].map(c=>{const bx=9+c*7.5,by=19+r*5.5;return<rect key={`${r}${c}`} x={bx} y={by} width="6" height="4.5" rx="1.5" fill={r===3&&c===3?"#e84444":r===0?"#a8b8d8":"#e8ecf8"} stroke={r===3&&c===3?"#c02020":r===0?"#8090b8":"#a8b0c8"} strokeWidth="0.8"/>}))} <ellipse cx="24" cy="10" rx="12" ry="3" fill="rgba(255,255,255,0.5)"/></svg>,
  ...
  "pueinet": (s) => <svg width={s} height={s} viewBox="0 0 48 48"><defs><linearGradient id="xpnet1" x1="0%" y1="0%" x2="0%" y2="100%"><stop offset="0%" stopColor="#5080e0"/><stop offset="100%" stopColor="#2040b0"/></linearGradient></defs><rect x="2" y="5" width="44" height="34" rx="3" fill="white" stroke="#4060c0" strokeWidth="1.5"/><rect x="2" y="5" width="44" height="11" rx="3" fill="url(#xpnet1)"/><rect x="2" y="12" width="44" height="4" fill="url(#xpnet1)"/><circle cx="8" cy="11" r="2.5" fill="rgba(255,255,255,0.7)"/><circle cx="14" cy="11" r="2.5" fill="rgba(255,255,255,0.7)"/><rect x="20" y="7.5" width="20" height="6" rx="3" fill="rgba(255,255,255,0.2)" stroke="rgba(255,255,255,0.3)" strokeWidth="1"/><rect x="8" y="22" width="32" height="3" rx="1.5" fill="#c0d0f0"/><rect x="8" y="28" width="22" height="3" rx="1.5" fill="#d8e8f8"/><rect x="8" y="34" width="28" height="3" rx="1.5" fill="#d8e8f8"/><rect x="16" y="39" width="16" height="4" rx="1" fill="#9090a8"/><rect x="12" y="43" width="24" height="3" rx="1.5" fill="#7878a0"/></svg>,
  "puei-cloud-chat": (s) => <svg width={s} height={s} viewBox="0 0 48 48"><defs><linearGradient id="xpchat" x1="0%" y1="0%" x2="0%" y2="100%"><stop offset="0%" stopColor="#60d060"/><stop offset="100%" stopColor="#208020"/></linearGradient></defs><path d="M5 10a4 4 0 014-4h30a4 4 0 014 4v19a4 4 0 01-4 4H28l-8 9v-9H9a4 4 0 01-4-4z" fill="url(#xpchat)" stroke="#188018" strokeWidth="1.5"/><rect x="10" y="14" width="28" height="3" rx="1.5" fill="rgba(255,255,255,0.9)"/><rect x="10" y="20" width="22" height="3" rx="1.5" fill="rgba(255,255,255,0.8)"/><rect x="10" y="26" width="16" height="3" rx="1.5" fill="rgba(255,255,255,0.7)"/><ellipse cx="24" cy="10" rx="14" ry="3.5" fill="rgba(255,255,255,0.35)"/></svg>,
  "puei-studio": (s) => <svg width={s} height={s} viewBox="0 0 48 48"><defs><radialGradient id="xpstar" cx="50%" cy="40%" r="60%"><stop offset="0%" stopColor="#ffd060"/><stop offset="100%" stopColor="#c07800"/></radialGradient></defs><path d="M24 6 L28 18 H40 L30 25 L34 37 L24 30 L14 37 L18 25 L8 18 H20 Z" fill="url(#xpstar)" stroke="#a06000" strokeWidth="1.5"/><path d="M24 6 L28 18 H40 L30 25 L34 37 L24 30 L14 37 L18 25 L8 18 H20 Z" fill="rgba(255,255,255,0)" stroke="rgba(255,255,255,0.4)" strokeWidth="1"/><ellipse cx="20" cy="13" rx="7" ry="3" fill="rgba(255,255,255,0.5)" transform="rotate(-30 20 13)"/></svg>,
  ...
  "computer": (s) => <svg width={s} height={s} viewBox="0 0 48 48"><defs><linearGradient id="xpmon" x1="0%" y1="0%" x2="0%" y2="100%"><stop offset="0%" stopColor="#d0d8f0"/><stop offset="100%" stopColor="#8898c0"/></linearGradient></defs><rect x="4" y="3" width="40" height="28" rx="4" fill="url(#xpmon)" stroke="#8090c0" strokeWidth="1.5"/><rect x="7" y="6" width="34" height="22" rx="2" fill="#d8ecff" stroke="#9090c0" strokeWidth="1"/><rect x="8" y="7" width="32" height="20" rx="1.5" fill="#f0f8ff"/><rect x="10" y="9" width="15" height="11" rx="1" fill="white" opacity="0.9"/><rect x="27" y="9" width="11" height="3.5" rx="1" fill="#b0c8e8" opacity="0.8"/><rect x="27" y="14" width="8" height="2.5" rx="1" fill="#b0c8e8" opacity="0.6"/><rect x="18" y="31" width="12" height="5" rx="1" fill="#9090b8" stroke="#7080a8" strokeWidth="1"/><rect x="14" y="36" width="20" height="3.5" rx="1.5" fill="#8888b0" stroke="#6878a0" strokeWidth="1"/><ellipse cx="24" cy="6" rx="14" ry="3.5" fill="rgba(255,255,255,0.55)"/></svg>,
  ...
  "pmail": (s) => <svg width={s} height={s} viewBox="0 0 48 48"><defs><linearGradient id="xpmail" x1="0%" y1="0%" x2="0%" y2="100%"><stop offset="0%" stopColor="#e8f0ff"/><stop offset="100%" stopColor="#9ab0e0"/></linearGradient></defs><rect x="3" y="10" width="42" height="28" rx="3" fill="url(#xpmail)" stroke="#5878c8" strokeWidth="1.5"/><path d="M3 12l21 15 21-15" fill="none" stroke="#5878c8" strokeWidth="2.5" strokeLinejoin="round"/><ellipse cx="24" cy="13" rx="14" ry="3.5" fill="rgba(255,255,255,0.5)"/></svg>,
...
const APP_ICON_SVGS_P3: Partial<Record<AppId, (s: number) => React.ReactNode>> = {
  ...
  "app-store": (s) => <svg width={s} height={s} viewBox="0 0 48 48"><rect width="48" height="48" rx="11" fill="#00acc1"/><path d="M10 21h28l-3 19H13z" fill="white" opacity="0.95"/><path d="M17 21c0-3.9 3.1-7 7-7s7 3.1 7 7" fill="none" stroke="white" strokeWidth="3" strokeLinecap="round"/><rect x="10" y="18" width="28" height="5" rx="2.5" fill="white" opacity="0.9"/><circle cx="19" cy="32" r="2" fill="#00acc1"/><circle cx="29" cy="32" r="2" fill="#00acc1"/></svg>,
  ...
  "computer": (s) => <svg width={s} height={s} viewBox="0 0 48 48"><rect width="48" height="48" rx="11" fill="#1565c0"/><rect x="6" y="8" width="36" height="24" rx="4" fill="#90caf9"/><rect x="8" y="10" width="32" height="20" rx="2.5" fill="#e3f2fd"/><rect x="10" y="12" width="14" height="10" rx="1.5" fill="white" opacity="0.85"/><rect x="26" y="12" width="12" height="3.5" rx="1.5" fill="#90caf9" opacity="0.8"/><rect x="26" y="17" width="8" height="2.5" rx="1.2" fill="#90caf9" opacity="0.6"/><rect x="18" y="32" width="12" height="5" rx="1.5" fill="#5c85d6"/><rect x="14" y="37" width="20" height="3" rx="1.5" fill="#42a5f5"/></svg>,
