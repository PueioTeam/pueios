...
const APP_ICON_SVGS: Partial<Record<AppId, (s: number) => React.ReactNode>> = {
  ...
  "computer": (s) => <svg width={s} height={s} viewBox="0 0 48 48"><rect x="4" y="3" width="40" height="28" rx="3" fill="#c8cce0" stroke="#8890b8" strokeWidth="1.5"/><rect x="7" y="6" width="34" height="22" rx="1.5" fill="#1a2a5a" stroke="#0a1840" strokeWidth="1"/><rect x="8" y="7" width="32" height="20" rx="1" fill="#1e3a8a"/><rect x="9" y="8" width="30" height="18" rx="0.5" fill="#1a3070"/>{/* scanlines */}<rect x="9" y="11" width="30" height="1" fill="rgba(255,255,255,0.04)"/><rect x="9" y="14" width="30" height="1" fill="rgba(255,255,255,0.04)"/><rect x="9" y="17" width="30" height="1" fill="rgba(255,255,255,0.04)"/><rect x="9" y="20" width="30" height="1" fill="rgba(255,255,255,0.04)"/><rect x="9" y="23" width="30" height="1" fill="rgba(255,255,255,0.04)"/>{/* Screen content: folder icon on desktop */}<rect x="11" y="10" width="6" height="5" rx="1" fill="#4a90d8" opacity="0.9"/><rect x="19" y="10" width="6" height="5" rx="1" fill="#4a90d8" opacity="0.9"/><rect x="27" y="10" width="6" height="5" rx="1" fill="#4a90d8" opacity="0.9"/>{/* taskbar */}<rect x="9" y="22" width="30" height="4" fill="#1155aa"/><rect x="10" y="22.5" width="6" height="3" rx="0.5" fill="#2266cc"/><circle cx="36" cy="24" r="1.2" fill="rgba(255,255,255,0.5)"/>{/* bezel bottom */}<rect x="4" y="29" width="40" height="2" rx="1" fill="#a8aec8" stroke="#7880b0" strokeWidth="0.5"/><circle cx="24" cy="30" r="1" fill="#8890b8"/>{/* neck */}<rect x="19" y="31" width="10" height="5" rx="1" fill="#b0b4cc" stroke="#8890b8" strokeWidth="1"/>{/* base */}<rect x="12" y="36" width="24" height="4" rx="2" fill="#c0c4d8" stroke="#9098c0" strokeWidth="1"/><ellipse cx="24" cy="7" rx="13" ry="3" fill="rgba(255,255,255,0.15)"/></svg>,
